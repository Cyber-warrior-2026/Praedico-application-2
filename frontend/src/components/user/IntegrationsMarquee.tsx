    ...
    <section className="relative w-full py-32 overflow-hidden bg-[#020617] font-sans text-white border-y border-white/5">
      ...
      <div className="container relative z-10 mx-auto px-6 text-center">
        ...
        <div className="mt-16 relative z-30">
          <button className="group relative inline-flex items-center gap-3 px-8 py-4 bg-[#5842c3] text-white font-bold rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(88,66,195,0.4)] hover:shadow-[0_0_60px_rgba(88,66,195,0.6)]">
