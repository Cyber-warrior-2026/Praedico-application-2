...
export default function PriceRangeSlider() {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm h-full">
      ...
      {/* Header */}
      <h3 className="font-bold text-slate-800 mb-6">Snapshot</h3>

      {/* Stats Grid */}
      <div className="grid grid-cols-2 gap-y-6 gap-x-4 mb-8">
        <div>
          <p className="text-xs text-slate-400 mb-1">Prev Close</p>
          <p className="text-lg font-bold text-slate-800">12,051.48</p>
        </div>
        <div className="text-right">
          <p className="text-xs text-slate-400 mb-1">Open</p>
          <p className="text-lg font-bold text-slate-800">12,000.21</p>
        </div>
        ...
        <div className="col-span-2 mt-2">
          ...
          <div className="relative w-full h-8 flex items-center">
            ...
            {/* Thumb Visual */}
            <div 
              className="absolute w-0.5 h-3.5 bg-slate-800 z-10 transition-all duration-75 ease-out pointer-events-none"
            ...
            {/* Value Label */}
            <div 
              className="absolute top-6 text-sm font-bold text-slate-800 transition-all duration-75 ease-out transform -translate-x-1/2"
      ...
      {/* Footer Info */}
      <div className="grid grid-cols-2 pt-6 border-t border-slate-100 mt-6">
        <div>
          <p className="text-xs text-slate-400 mb-1">Trade Time</p>
          <p className="text-lg font-bold text-slate-800">05:16 PM</p>
        </div>
        <div className="text-right">
          <p className="text-xs text-slate-400 mb-1">Trade Date</p>
          <p className="text-lg font-bold text-slate-800">01/27/23</p>
        </div>
      </div>
