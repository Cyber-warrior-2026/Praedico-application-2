...
export default function CoordinatorAllStudentsPage() {
    ...
    const fetchStudents = async () => {
        try {
            const data = await coordinatorApi.getAllStudents();
            if (data.success) {
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 border border-gray-300 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none dark:bg-slate-800 dark:text-white"
                        />
                    </div>
                </div>
            </div>
