...
import {
    LogOut, User, Settings, Bell, Menu, Search, Users, Command
} from "lucide-react";
import {
    DropdownMenu,
    DropdownMenuContent,
        ...
        >
         ...
         ======================= */}
            <div className="flex items-center gap-8">
                ...
                <div className="hidden md:flex group relative">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full opacity-30 group-hover:opacity-70 blur transition duration-500"></div>
                    <div className="relative flex items-center bg-[#1e293b] rounded-full px-4 py-2 w-80 ring-1 ring-slate-700/50 group-hover:ring-purple-500/50 transition-all">
                        <Search className="h-4 w-4 text-slate-400 group-hover:text-purple-400 transition-colors mr-3" />
                        <input
                            type="text"
         ...
         ======================= */}
            <div className="flex items-center gap-5">
                ...
                {/* Notification Bell */}
                <button className="relative flex items-center justify-center h-10 w-10 rounded-full bg-slate-800/50 text-slate-400 hover:text-white hover:bg-slate-700 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] transition-all duration-300 border border-slate-700 group">
                        ...
                        <button className="flex items-center gap-3 group outline-none">
                            ...
                            <div className="relative h-11 w-11 p-[2px] rounded-full bg-gradient-to-tr from-purple-500 via-pink-500 to-rose-500 group-hover:rotate-180 transition-all duration-700">
                                <Avatar className="h-full w-full border-2 border-[#0f172a] group-hover:rotate-[-180deg] transition-all duration-700">
                                    <AvatarImage src="/avatars/coord-default.png" alt="Coord" />
