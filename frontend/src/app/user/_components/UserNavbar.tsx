  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1920px] mx-auto px-6 md:px-8 h-20 flex items-center justify-between relative z-50">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="xl:hidden h-11 w-11 flex items-center justify-center rounded-full bg-white border border-slate-200/60 text-slate-500 hover:text-indigo-600 hover:bg-indigo-50/50 transition-all active:scale-95"
            >
        ...
        {mobileMenuOpen && (
          <div className="absolute top-20 left-0 w-full bg-white/80 backdrop-blur-2xl border-b border-indigo-100/50 shadow-2xl shadow-indigo-500/10 p-6 flex flex-col gap-4 animate-mobile-menu zl:hidden origin-top scale-y-100">

            {/* Mobile Profile Snippet */}
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/50 border border-slate-200/50 mb-2">
            ...
            <button
              ...
              className="w-full py-3 rounded-2xl bg-red-50 text-red-600 font-bold text-sm hover:bg-red-100 transition-colors flex items-center justify-center gap-2"
            >
