...
import { TrendingUp, Layers, ArrowRight, Activity, Sparkles, BarChart2 } from "lucide-react"; // ← Changed BarChart3 to BarChart2
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r 
            ...
            <BarChart2 className="w-4 h-4 text-blue-600 animate-pulse" /> {/* ← Changed from BarChart3 */}
              ...
              >
                ...
                {isHovered && (
                  <>
                    ...
                    <div className="absolute top-12 right-8 w-1 h-1 rounded-full bg-pink-400 
