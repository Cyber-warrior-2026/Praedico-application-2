...
export default function Nifty50Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-background dark:via-background dark:to-background pt-24 pb-12 px-4 md:px-6 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900/30
                             border border-blue-200 dark:border-blue-800 mb-3 animate-pulse">
                <TrendingUp className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                <span className="text-xs font-semibold text-blue-700 dark:text-blue-300">NIFTY 50</span>
              </div>
              ...
              <p className="text-gray-600 dark:text-slate-400 text-sm md:text-lg">Real-time data from NSE India</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between 
            ...
            <div className="w-full md:w-auto flex flex-row items-center justify-between md:justify-end gap-3">
              <div className="flex-1 md:flex-none px-5 py-3 rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 dark:from-slate-800 dark:to-slate-900
                             border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all text-center md:text-left">
        ...
        {loading && stocks.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 animate-pulse">
            ...
            <p className="text-gray-600 dark:text-slate-400 text-lg">Loading Nifty 50 stocks...</p>
          </div>
        ) : (
            ...
            <div className="overflow-x-auto">
              <div className="min-w-[800px]">
                ...
                <div className="grid grid-cols-12 gap-4 px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-slate-800 dark:to-slate-900
                  ...
                  <div className="col-span-3 flex items-center gap-2 cursor-pointer hover:text-blue-600 dark:hover:text-blue-400
