...
export default function CoordinatorSidebar() {
    ...
    const MENU_ITEMS: MenuItem[] = [
        ...
        { href: '/coordinator/students/pending', label: 'Pending Approvals', icon: UserCheck, badge: pendingCount },
        { href: '/coordinator/students', label: 'All Students', icon: GraduationCap },
    ];
